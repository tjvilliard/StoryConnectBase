...
```
cd existing_repo
git remote add origin https://capstone-cs.eng.utah.edu/storyconnect/storyconnect.git
git branch -M main
...
- [ ] [Set up project integrations](https://capstone-cs.eng.utah.edu/storyconnect/storyconnect/-/settings/integrations)
