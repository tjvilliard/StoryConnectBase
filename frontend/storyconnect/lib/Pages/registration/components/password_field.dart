    ...
    return BlocBuilder<RegistrationBloc, RegistrationState>(builder: (BuildContext context, RegistrationState state) {
      ...
      return Container(
          ...
          child: TextField(
            ...
            onChanged: (_) {
              context.read<RegistrationBloc>().add(PasswordFieldChangedEvent(password: _passwordController.text));
            },
            decoration: InputDecoration(
                ...
                suffixIcon: IconButton(
                  ...
                  onPressed: () {
                    context.read<RegistrationBloc>().add(ShowPasswordClickedEvent());
                  },
                ),
                labelText: 'Password',
