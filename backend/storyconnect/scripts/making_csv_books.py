...
# add_col = ['owner', 'target_audience', 'book_status', 'cover','modified', 'synopsis', 'copyright' ,'titlepage']
data_t = data.transpose()
print(data_t.columns)
data_t.rename(columns={1:'title', 2: 'author', 3: 'language', 4:'subject', 5: 'released date'}, inplace=True)
data_t['owner'] = [3, 3, 3,3 ,3 ,3 ,3 ,3, 3, 3]
...
field_names = ['title','author', 'owner', 'language','target_audience', 'book_status', 'tags', 'cover', 'created', 'modified', 'synopsis', 'copyright' ,'titlepage']
